...
public class AppInit extends AbstractAnnotationConfigDispatcherServletInitializer {
    ...
    public void onStartup(ServletContext aContext) throws ServletException {
        ...
        FilterRegistration.Dynamic registerHiddenFilter = aContext.addFilter("hiddenHttpMethodFilter", new HiddenHttpMethodFilter());
        registerHiddenFilter.addMappingForUrlPatterns(null, true, "/*");
